...
const DrawerDescription = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)(vaul_1.Drawer.Description, { ref: ref, className: (0, utils_1.cn)("text-sm text-zinc-500", className), ...props })));
